      ...
      <div className="app-layout">
        <aside className="sidebar">
          <div className="sidebar-top">
            <NavLink to="/" end className={({ isActive }) => 'sb-icon' + (isActive ? ' active' : '')} title="Dashboard">
            ...
            <NavLink to="/inventory" className={({ isActive }) => 'sb-icon' + (isActive ? ' active' : '')} title="Inventory">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="18" x2="21" y2="18" /></svg>
            </NavLink>
            <span className="sb-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="7 7 17 17" /><polyline points="17 7 17 17 7 17" /></svg>
            </span>
            <span className="sb-icon">
